(function() {
	...
	ScheduleTemplate.prototype.sendPatientReminderHandler = function(evt) {
		...
		let message = `${this.modal.getAttribute("data-participant-name")}, Your appointment with Dr. Demo is getting ready to begin. Please join by clicking the link: ${joinUrl}`;
